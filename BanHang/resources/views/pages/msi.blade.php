        ...
        <div class="col-md-12">
	            	<div class="panel " style="border: #F3F3F3 1px">            
		            	<div class="panel-heading" style="background-color:#F3F3F3; color:black; padding-bottom: 25px" >
		            		<h3 style="margin-top:0px; margin-bottom:0px;">Laptop MSI</h3>
		            	</div>
		            	<div class="panel-body">		
		            		<!-- item -->
						    <div class="row-item ">
						    	@foreach($msi as $laptopmsi)
			                	<div class="col-md-3 border-right" id="sanpham">
			                		<div class="col-md-12 border-bottom">
				                        <a href="chitiet/{{ $laptopmsi->id }}">
				                            <img class="img-responsive" src="uploads/product/product{{ $laptopmsi->id }}/{{ $laptopmsi->HINHANH }}" alt="{{ $laptopmsi->TENSP }}" title="{{ $laptopmsi->TENSP }}">
				                        </a>
				                    </div>

				                    <div class="col-md-12">
				                        <span>
				                        	<a href="chitiet/{{ $laptopmsi->id }}"><h5> {{ catchuoi($laptopmsi->TENSP,28) }} </h5></a>
				                        </span>
				                        <span class="text-danger"><strong>{{ number_format($laptopmsi->GIASP) }} đ</strong></span>
				                        
				                        <div id="ts-item">
				                        	<ul class="list-unstyled">
												<?php 
													$ct = DB::table('chitietsp')->where('IDSP',$laptopmsi->id)->get();
            		...
            		<div class="pagination text-danger" style="float: right">{!! $msi->links() !!}</div>
