        ...
        <div class="col-md-12">
	            	<div class="panel " style="border: #F3F3F3 1px">            
		            	<div class="panel-heading" style="background-color:#F3F3F3; color:black; padding-bottom: 25px" >
		            		<h3 style="margin-top:0px; margin-bottom:0px;">Laptop Apple</h3>
		            	</div>
		            	<div class="panel-body">		
		            		<!-- item -->
						    <div class="row-item ">
						    	@foreach($apple as $laptopapple)
			                	<div class="col-md-3 border-right" id="sanpham">
			                		<div class="col-md-12 border-bottom">
				                        <a href="chitiet/{{ $laptopapple->id }}">
				                            <img class="img-responsive" src="uploads/product/product{{ $laptopapple->id }}/{{ $laptopapple->HINHANH }}" alt="{{ $laptopapple->TENSP }}" title="{{ $laptopapple->TENSP }}">
				                        </a>
				                    </div>

				                    <div class="col-md-12">
				                        <span>
				                        	<a href="chitiet/{{ $laptopapple->id }}"><h5> {{ catchuoi($laptopapple->TENSP,28) }} </h5></a>
				                        </span>
				                        <span class="text-danger"><strong>{{ number_format($laptopapple->GIASP) }} đ</strong></span>
				                        
				                        <div id="ts-item">
				                        	<ul class="list-unstyled">
												<?php 
													$ct = DB::table('chitietsp')->where('IDSP',$laptopapple->id)->get();
            		...
            		<div class="pagination" style="float: right">{!! $apple->links() !!}</div>
