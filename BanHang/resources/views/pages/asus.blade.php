        ...
        <div class="col-md-12">
	            	<div class="panel " style="border: #F3F3F3 1px">            
		            	<div class="panel-heading" style="background-color:#F3F3F3; color:black; padding-bottom: 25px" >
		            		<h3 style="margin-top:0px; margin-bottom:0px;">Laptop Asus</h3>
		            	</div>
		            	<div class="panel-body">		
		            		<!-- item -->
						    <div class="row-item ">
						    	@foreach($asus as $laptopasus)
			                	<div class="col-md-3 border-right" id="sanpham">
			                		<div class="col-md-12 border-bottom">
				                        <a href="chitiet/{{ $laptopasus->id }}">
				                            <img class="img-responsive" src="uploads/product/product{{ $laptopasus->id }}/{{ $laptopasus->HINHANH }}" alt="{{ $laptopasus->TENSP }}" title="{{ $laptopasus->TENSP }}">
				                        </a>
				                    </div>

				                    <div class="col-md-12">
				                        <span>
				                        	<a href="chitiet/{{ $laptopasus->id }}"><h5> {{ catchuoi($laptopasus->TENSP,28) }} </h5></a>
				                        </span>
				                        <span class="text-danger"><strong>{{ number_format($laptopasus->GIASP) }} đ</strong></span>
				                        
				                        <div id="ts-item">
				                        	<ul class="list-unstyled">
												<?php 
													$ct = DB::table('chitietsp')->where('IDSP',$laptopasus->id)->get();
            		...
            		<div class="pagination" style="float: right">{!! $asus->links() !!}</div>
