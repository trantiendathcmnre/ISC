        ...
        <div class="col-md-12">
	            	<div class="panel " style="border: #F3F3F3 1px">            
		            	<div class="panel-heading" style="background-color:#F3F3F3; color:black; padding-bottom: 25px" >
		            		<h3 style="margin-top:0px; margin-bottom:0px;">Laptop Acer</h3>
		            	</div>
		            	<div class="panel-body">		
		            		<!-- item -->
						    <div class="row-item ">
						    	@foreach($acer as $laptopacer)
			                	<div class="col-md-3 border-right" id="sanpham">
			                		<div class="col-md-12 border-bottom">
				                        <a href="chitiet/{{ $laptopacer->id }}">
				                            <img class="img-responsive" src="uploads/product/product{{ $laptopacer->id }}/{{ $laptopacer->HINHANH }}" alt="{{ $laptopacer->TENSP }}" title="{{ $laptopacer->TENSP }}">
				                        </a>
				                    </div>

				                    <div class="col-md-12">
				                        <span>
				                        	<a href="chitiet/{{ $laptopacer->id }}"><h5> {{ catchuoi($laptopacer->TENSP,28) }} </h5></a>
				                        </span>
				                        <span class="text-danger"><strong>{{ number_format($laptopacer->GIASP) }} đ</strong></span>
				                        
				                        <div id="ts-item">
				                        	<ul class="list-unstyled">
												<?php 
													$ct = DB::table('chitietsp')->where('IDSP',$laptopacer->id)->get();
            		...
            		<div class="pagination" style="float: right">{!! $acer->links() !!}</div>
